...
public class UserDaoImpl implements UserDao {
	...
	public UserDaoImpl() throws SQLException {
		...
		pst4=cn.prepareStatement("delete from users where id=? and role='voter'");
		
		pst5=cn.prepareStatement("update users set password=? where email=? and password=? and role='voter'");
	}
	...
	public String deleteVoter(int voterId)throws SQLException
	{
		...
		return "Can't delete voter!!!";
	}
	//add chnagepassword method
	public String changePassword(String email,String oldpass,String newpass)throws SQLException
	{
		pst5.setString(1, newpass);
		pst5.setString(2, email);
		pst5.setString(3, oldpass);
